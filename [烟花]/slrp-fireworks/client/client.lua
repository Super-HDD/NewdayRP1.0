...
-- BIG FIREWORKS
RegisterNetEvent('slrp-fireworks:big_fireworks')
AddEventHandler('slrp-fireworks:big_fireworks', function()
    ...
    Wait(5000)
    TriggerServerEvent("slrp-fireworks:players", GetEntityCoords(big_fireworks_object), "big_fireworks")

    Wait(Config.big_fireworks_time * 1000 + 10000)
    DeleteObject(big_fireworks_object)
end)

RegisterNetEvent('slrp-fireworks:big_fireworks_players')
AddEventHandler('slrp-fireworks:big_fireworks_players', function(coords)
...
-- SMALL FIREWORKS
RegisterNetEvent('slrp-fireworks:small_fireworks')
AddEventHandler('slrp-fireworks:small_fireworks', function()
    TaskStartScenarioInPlace(PlayerPedId(), GetHashKey('WORLD_HUMAN_CROUCH_INSPECT'), 7000, true, false, false, false)
    Wait(7000)
    ...
    Wait(5000)
    TriggerServerEvent("slrp-fireworks:players", GetEntityCoords(small_fireworks_object), "small_fireworks")

    Wait(Config.small_fireworks_time * 1000 + 10000)
    DeleteObject(small_fireworks_object)
end)

RegisterNetEvent('slrp-fireworks:small_fireworks_players')
AddEventHandler('slrp-fireworks:small_fireworks_players', function(coords)
...
-- BIG FIRECRACKER
RegisterNetEvent('slrp-fireworks:big_firecracker')
AddEventHandler('slrp-fireworks:big_firecracker', function()
    ...
    TriggerServerEvent("slrp-fireworks:players", vector3(coords.x, coords.y, z), "big_firecracker")
end)

RegisterNetEvent('slrp-fireworks:big_firecracker_players')
AddEventHandler('slrp-fireworks:big_firecracker_players', function(coords)
    Citizen.InvokeNative(0x53BA259F3A67A99E, coords, 31, 0xC22E127D, 0.0, true, false, true, 0.0)   -- AddExplosionWithUserVfx
end)

-- SMALL FIRECRACKER
RegisterNetEvent('slrp-fireworks:small_firecracker')
AddEventHandler('slrp-fireworks:small_firecracker', function()
    local animDict = "amb_camp@world_camp_jack_throws_rocks_casual@male_a@wip_base"
    local animName = "base"
    local duration = 6500
    local flags = 2
    ...
    local coords = GetOffsetFromEntityInWorldCoords(PlayerPedId(), 0.0, 15.0, 0.0)
    local _, z = GetGroundZAndNormalFor_3dCoord(coords.x, coords.y, coords.z + 100)
    TriggerServerEvent("slrp-fireworks:players", vector3(coords.x, coords.y, z), "small_firecracker")
end)

RegisterNetEvent('slrp-fireworks:small_firecracker_players')
AddEventHandler('slrp-fireworks:small_firecracker_players', function(coords)
    for i = 1, 3 do
...
-- SMOKE CAMPFIRE
RegisterNetEvent('slrp-fireworks:smoke_campfire')
AddEventHandler('slrp-fireworks:smoke_campfire', function()
    ...
    TriggerServerEvent("slrp-fireworks:players", GetEntityCoords(smoke_campfire_object), "smoke_campfire")

    Wait(Config.smoke_campfire_time * 1000 + 10000)
    DeleteObject(smoke_campfire_object)
end)

RegisterNetEvent('slrp-fireworks:smoke_campfire_players')
AddEventHandler('slrp-fireworks:smoke_campfire_players', function(coords)
