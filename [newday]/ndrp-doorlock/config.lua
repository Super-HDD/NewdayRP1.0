...
Config.DoorList = {
    ...
    -----------------------------------------------------
    -- Valentine Doctor Office 
    -----------------------------------------------------
    { -- front door
        authorizedJobs = { 'medic' },
        doorid = 3588026089,
        objCoords  = vector3(-282.81, 803.95, 118.39),
        textCoords  = vector3(-282.81, 803.95, 118.39),
        objYaw = 10.0,
        locked = true,
        distance = 3.0
    },
    { -- back door
        authorizedJobs = { 'medic' },
        doorid = 3439738919,
        objCoords  = vector3(-281.07, 815.24, 118.42),
        textCoords  = vector3(-281.07, 815.24, 118.42),
        objYaw = 10.0,
        locked = true,
        distance = 3.0
    },
    -----------------------------------------------------
    -- Valentine WeaponSmith
    -----------------------------------------------------
    { -- front door
        authorizedJobs = { 'valweaponsmith' },
        doorid = 475159788,
        objCoords  = vector3(-283.54, 784.41, 118.53),
        textCoords  = vector3(-283.54, 784.41, 118.53),
        objYaw = 10.0,
        locked = true,
        distance = 3.0
    },
    { -- back door
        authorizedJobs = { 'valweaponsmith' },
        doorid = 2042647667,
        objCoords  = vector3(-276.66, 776.6, 118.55),
        textCoords  = vector3(-276.66, 776.6, 118.55),
        objYaw = 10.0,
        locked = true,
        distance = 3.0
    },
    -----------------------------------------------------
    -- Valentine Saloontender
    -----------------------------------------------------
    {--老板房间
        authorizedJobs = { 'valsaloontender' },
        doorid = 1087218607,
        objCoords  = vector3(-314.84, 818.18, 120.97),
        textCoords  = vector3(-314.84, 818.18, 120.97),
        objYaw = 10.0,
        locked = true,
        distance = 1.5
    },
    ...
    -----------------------------------------------------
    { -- front door
        authorizedJobs = { 'rhoweaponsmith' },
        doorid = 393076024,
        objCoords  = vector3(1326.43, -1319.07, 76.89),
        textCoords  = vector3(1326.43, -1319.07, 76.89),
        objYaw = 160.0,
        locked = true,
        distance = 3.0
    },
    { -- back door 1
        authorizedJobs = { 'rhoweaponsmith' },
        doorid = 934926308,
        objCoords  = vector3(1319.53,-1324.39,76.89),
        textCoords  = vector3(1319.53,-1324.39,76.89),
        objYaw = -110.0,
        locked = true,
        distance = 3.0
    },
    { -- back door 1
        authorizedJobs = { 'rhoweaponsmith' },
        doorid = 743565308,
        objCoords  = vector3(1329.82,-1329.2,76.89),
        textCoords  = vector3(1329.82,-1329.2,76.89),
        objYaw = -110.0,
        locked = true,
        distance = 3.0
    },
    ...
    -----------------------------------------------------
    -- Blackwater Saloontender
    -----------------------------------------------------
    {--浴室门
        authorizedJobs = { 'blasaloontender' }, 
        doorid = 815031507,
        objCoords  = vector3(-824.13, -1322.8, 42.69),
        textCoords  = vector3(-824.13, -1322.8, 42.69),
        objYaw = -90.0,
        locked = true,
        distance = 3.0
    },
