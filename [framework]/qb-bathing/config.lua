...
Config.Prompts = {
    { label = ("开始洗浴 (%s$)"):format(Config.NormalBathPrice), id = "START_BATHING" },
    { label = "正规擦洗服务 ", id = "SCRUB", control = `INPUT_CONTEXT_X`, time = 2000 },
    { label = ("进阶洗浴项目 (%s$)"):format(Config.DeluxeBathPrice), id = "REQUEST_DELUXE_BATHING" },
    { label = "结束洗浴", id = "STOP_BATHING", control = `INPUT_INTERACT_NEG` }
}
