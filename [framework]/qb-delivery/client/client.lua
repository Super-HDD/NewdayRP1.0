...
Citizen.CreateThread(function()
    for delivery, v in pairs(Config.DeliveryLocations) do
        exports['qb-core']:createPrompt(v.deliveryid, v.startcoords, QBCore.Shared.Keybinds['J'], v.name, {
            type = 'client',
            event = 'qb-delivery:client:vehiclespawn',
...
RegisterNetEvent('qb-delivery:client:vehiclespawn')
AddEventHandler('qb-delivery:client:vehiclespawn', function(deliveryid, cart, cartspawn, cargo, light, endcoords, showgps)
            ...
            if wagonSpawned == true then
                ...
                if #(vehpos - endcoords) < 250.0 then
                    ...
                    if #(vehpos - endcoords) < 3.0 then
                        ...
                        TriggerServerEvent('qb-delivery:server:givereward', cashreward)
                        wagonSpawned = false
                    end
                end
            end
