...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 150, bank = 150, bloodmoney = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Player.HungerRate = 1.0 -- Rate at which hunger goes down.
QBConfig.Player.ThirstRate = 1.0 -- Rate at which thirst goes down.
...
QBConfig.Server.ClosedReason = "Server Closed" -- 当人们无法加入服务器时显示的原因消息
