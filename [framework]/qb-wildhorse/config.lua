...
Config.Cooldown = 300 -- 15 mins cooldown by default
...
{
    {name = '瓦伦丁卖马人',      location = 'valentine-sellwildhorse',     coords = vector3(-382.54, 788.06, 115.91 -0.8), showblip = true }, --valentine
    {name = '圣丹尼斯卖马者',       location = 'stdenis-sellwildhorse',       coords = vector3(2839.5, -1305.68, 46.66 -0.8), showblip = true }, --stdenis
    {name = '西伊丽莎白卖马者', location = 'westelizabeth-sellwildhorse', coords = vector3(-2543.44, 401.73, 148.28 -0.8), showblip = true }, --westelizabeth
    {name = '草莓卖马场',      location = 'stawberry-sellwildhorse',     coords = vector3(-3641.46, -2626.49, -13.73 -0.8), showblip = true }, --stawberry
    {name = '风滚草卖马者',     location = 'tumbleweed-sellwildhorse',    coords = vector3(-5527.8, -2948.04, -1.56 -0.8), showblip = true }, --tumbleweed
    {name = '黑水卖马者',     location = 'blackwater-sellwildhorse',    coords = vector3(-945.21, -1337.29, 50.65 -0.8), showblip = true }, --blackwater
    {name = '罗德卖马者',         location = 'rhodes-sellwildhorse',        coords = vector3(1434.89, -1291.61, 77.82 -0.8), showblip = true }, --blackwater
    {name = '范霍恩卖马者',       location = 'vanhorn-sellwildhorse',       coords = vector3(2932.95, 568.53, 44.99 -0.8), showblip = true }, --blackwater
}
