...
1. Make sure to rename to qb-mdt then ensure qb-mdt on your resources list. Also disable any other mdt script you are using.
...
For use through radial menu add code snippet thats below in qb-radialmenu\config.lua after line 302 (lawbadge)
