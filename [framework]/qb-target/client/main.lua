                                ...
                                while targetActive and success do
                                    ...
                                    if hit and entity == entity2 then
                                        ...
                                        if closestBone ~= closestBone2 then
                                            if IsControlReleased(0, QBCore.Shared.Keybinds['LALT']) then
                                            ...
                                            self:DrawOutlineEntity(entity, false)
                                            break
                                        elseif not hasFocus and IsDisabledControlPressed(0, QBCore.Shared.Keybinds['MOUSE1']) then
...
CreateThread(function()
    while true do
        ...
        if Config.Toggle then
            if IsControlJustPressed(0, QBCore.Shared.Keybinds['LALT']) then
                playerPed = PlayerPedId()
            ...
            if IsControlPressed(0, QBCore.Shared.Keybinds['LALT']) then
                playerPed = PlayerPedId()
                SetCurrentPedWeapon(playerPed, `WEAPON_UNARMED`, true)
                if (not enabled) then
                    ExecuteCommand('+playerTarget')
            ...
            elseif IsControlReleased(0, QBCore.Shared.Keybinds['LALT']) then
                if enabled then
                    ExecuteCommand('-playerTarget')
                    enabled = false
                end
