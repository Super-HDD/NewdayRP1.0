...
-- make bait useable
QBCore.Functions.CreateUseableItem("p_baitbread01x", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)

QBCore.Functions.CreateUseableItem("p_baitcorn01x", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)

QBCore.Functions.CreateUseableItem("p_baitcheese01x", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)

QBCore.Functions.CreateUseableItem("p_baitworm01x", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)

QBCore.Functions.CreateUseableItem("p_baitcricket01x", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)

QBCore.Functions.CreateUseableItem("p_crawdad01x", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)

QBCore.Functions.CreateUseableItem("p_finishedragonfly01x", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)

QBCore.Functions.CreateUseableItem("p_finisdfishlure01x", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)

QBCore.Functions.CreateUseableItem("p_finishdcrawd01x", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)

QBCore.Functions.CreateUseableItem("p_finishedragonflylegendary01x", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateUseableItem("p_finisdfishlurelegendary01x", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)

QBCore.Functions.CreateUseableItem("p_finishdcrawdlegendary01x", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)

QBCore.Functions.CreateUseableItem("p_lgoc_spinner_v4", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)

QBCore.Functions.CreateUseableItem("p_lgoc_spinner_v6", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-fishing:client:usebait", source, item.name)
end)
...
RegisterServerEvent('qb-fishing:server:removeBaitItem')
AddEventHandler('qb-fishing:server:removeBaitItem', function(item)
    local src = source
...
RegisterServerEvent('qb-fishing:FishToInventory')
AddEventHandler("qb-fishing:FishToInventory", function(fishModel, weight)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    TriggerClientEvent('QBCore:Notify', src, Lang:t('primary.you_got_fish_name',{fish_name = fish_name}), 'primary')
    TriggerEvent('qb-log:server:CreateLog', 'fishing', 'Fish Caught', 'green', firstname..' '..lastname..' caught a '..fish_weight..'KG '..fish_name)
end)
