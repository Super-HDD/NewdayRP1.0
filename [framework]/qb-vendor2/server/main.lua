...
AddEventHandler('onResourceStart', function(resource)
    if resource == GetCurrentResourceName() then
        ...
        TriggerEvent("qb-vendoer:server:vendorAutoAdd")
        end
    end
end)
...
QBCore.Functions.CreateCallback('qb-vendoer:server:vendor', function(source, cb)
    local src = source
...
QBCore.Functions.CreateCallback('qb-vendoer:server:vendorOwned', function(source, cb, currentvendor)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local Playercid = Player.PlayerData.citizenid
...
QBCore.Functions.CreateCallback('qb-vendoer:server:vendorOwner', function(source, cb, currentvendor)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local Playercid = Player.PlayerData.citizenid
...
QBCore.Functions.CreateCallback('qb-vendoer:server:vendorS', function(source, cb, currentvendor)
...
QBCore.Functions.CreateCallback('qb-vendoer:server:vendorGetMoney', function(source, cb, currentvendor)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local Playercid = Player.PlayerData.citizenid
...
RegisterServerEvent("qb-vendoer:server:vendorGetShopItems")
AddEventHandler("qb-vendoer:server:vendorGetShopItems", function(shopName)
...
RegisterServerEvent("qb-vendoer:server:vendorPurchaseItem")
AddEventHandler("qb-vendoer:server:vendorPurchaseItem", function(location, item, amount)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local Playercid = Player.PlayerData.citizenid
...
RegisterServerEvent("qb-vendoer:server:vendorInvReFill")
AddEventHandler("qb-vendoer:server:vendorInvReFill", function(location, item, qt, amount)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local Playercid = Player.PlayerData.citizenid
...
RegisterServerEvent("qb-vendoer:server:vendorWithdraw")
AddEventHandler("qb-vendoer:server:vendorWithdraw", function(location, omoney)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local Playercid = Player.PlayerData.citizenid
...
RegisterServerEvent("qb-vendoer:server:vendorBuyEtal")
AddEventHandler("qb-vendoer:server:vendorBuyEtal", function(location, price)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local Playercid = Player.PlayerData.citizenid
...
RegisterServerEvent("qb-vendoer:server:vendorGiveBusiness")
AddEventHandler("qb-vendoer:server:vendorGiveBusiness", function(location, tocid)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local Playercid = Player.PlayerData.citizenid
...
RegisterServerEvent("qb-vendoer:server:vendorGetName")
AddEventHandler("qb-vendoer:server:vendorGetName", function(shopName)
    local _source = source
    exports['oxmysql']:execute('SELECT * FROM market_items WHERE marketid = ?', {shopName}, function(data)
...
RegisterServerEvent("qb-vendoer:server:vendorName")
AddEventHandler("qb-vendoer:server:vendorName", function(location, name)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local Playercid = Player.PlayerData.citizenid
...
RegisterServerEvent("qb-vendoer:server:vendorRob")
AddEventHandler("qb-vendoer:server:vendorRob", function(location)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local Playercid = Player.PlayerData.citizenid
...
RegisterServerEvent("qb-vendoer:server:vendorAutoAdd")
AddEventHandler("qb-vendoer:server:vendorAutoAdd", function()
