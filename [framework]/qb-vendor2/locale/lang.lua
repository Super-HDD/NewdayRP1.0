local en = {
  ...
  menu = {
    ...
    buy = '购买',
    buy_sub = "购买价格",
    open_market = '鲍勃和哈兰德的狩猎小屋',
    open_market_sub = '购买狩猎武器',
    rob = '抢劫',
    rob_sub = '自担风险',
    refill = '补充货物',
    refill_sub = '将武器放在摊位上',
    refill_in = '这是可供出售的武器列表！',
    checkmoney = '查看收银机',
    checkmoney_sub = '检查/收取余额',
    manage = '狩猎小屋管理',
    manage_sub = '管理名称、授予狩猎小屋、取回商品',
    market_sub = '这是武器列表、库存和单价',
    instock = '一份记录',
    price = '单价：$',
    no_item = '无产品',
    no_item_sub = '您没有产品放在狩猎小屋上！',
    in_inv = '在库存中',
    ...
    manage_in = '管理您的狩猎小屋',
    manage_in_name = '更改名称',
    manage_in_name_sub = '为您的狩猎小屋选择一个新名称？',
    manage_in_give_market = '授予狩猎小屋',
