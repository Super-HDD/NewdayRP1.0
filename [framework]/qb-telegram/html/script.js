...
$(function ()
{
    window.addEventListener('message', function (event)
    {
        ...
        {
            $("#view_id").text(event.data.telegram.citizenid)
...
$(document).ready(function()
{
    $("#inboxList").on("click",'li',function(event)
    {
        ...
        $.post('https://qb-telegram/getview', JSON.stringify({id: $(this).data('id')}));
        $(".inbox").fadeOut().hide();
        $(".view").fadeIn().show();
    });
});
...
{
    $.post('https://qb-telegram/NUIFocusOff', JSON.stringify({}));
});

// delete message
$(".telegram_delete_button").click(function(event)
{
    $.post('https://qb-telegram/delete', JSON.stringify({id: itemToDel}));
    $.post('https://qb-telegram/NUIFocusOff', JSON.stringify({}));
});