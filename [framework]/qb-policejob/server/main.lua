...
QBCore.Functions.CreateCallback('police:server:GetSuspectHorse', function(source, cb, id)
...
RegisterNetEvent('police:server:JailPlayer', function(playerId, time)
    ...
    if Player.PlayerData.job.name == "police" then
        if OtherPlayer then
            ...
            TriggerClientEvent('QBCore:Notify', src, Lang:t("info.sent_jail_for", {time = time}), 'primary')
        end
    end
end)
...
RegisterNetEvent('police:server:SearchPlayer', function(playerId)
    ...
    if SearchedPlayer then
        TriggerClientEvent('QBCore:Notify', src, Lang:t("info.cash_found", {cash = SearchedPlayer.PlayerData.money["cash"]}), 'primary')
        TriggerClientEvent('QBCore:Notify', SearchedPlayer.PlayerData.source, Lang:t("info.being_searched"), 'primary')
    end
end)
