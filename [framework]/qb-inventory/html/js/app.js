    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p style=\"font-size:11px\"><b>重量: </b>" + itemData.weight + " | <b>数量: </b> " + itemData.amount + " | <b>耐久度: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>"
...
function handleDragDrop() {
    $(".item-drag").draggable({
        ...
        start: function(event, ui) {
            ...
            if(dragAmount>itemData.amount)dragAmount=itemData.amount;
            if (!itemData.useable) {
    ...
    $(".item-slot").droppable({
        ...
        drop: function(event, ui) {
            ...
            if(toAmount>fromDataUnique.amount)toAmount=fromDataUnique.amount;
            if (fromSlot == toSlot && fromInventory == toInventory) {
                return;
            }
            if (toAmount >= 0) {
    ...
    $("#item-drop").droppable({
        ...
        drop: function(event, ui) {
            ...
            if(amount>fromData.amount)amount=fromData.amount;
            if (amount == 0) {
