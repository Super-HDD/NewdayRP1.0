...
Config.PedList = {
    ...
    {    -- pet vendor 
        ...
        coords = vector4(-1683.2900, -337.0850, 173.9444, 219.9158),
    },
    {    -- cart hire Valentine
    ...
    {   -- delivery Oil Fields
        model = `U_M_M_HtlForeman_01`,
        coords = vector4(383.2161, 656.0731, 114.4702, 326.2017),
    },
    {   -- railroad job valentine station npc1
        model = `U_M_O_RigTrainStationWorker_01`,
        coords = vector4(-162.6976, 638.8612, 114.03211, 146.25543),
    },
    {   -- railroad job valentine station npc2
        model = `U_M_O_RigTrainStationWorker_01`,
        coords = vector4(-164.3551, 639.8711, 114.0321, 144.0301),
    },
    {   -- railroad job rhode station npc
        model = `U_M_O_RigTrainStationWorker_01`,
        coords = vector4(1241.63, -1317.9, 76.9, 125.34),
    },
    {   -- railroad job denis station npc
        model = `U_M_O_RigTrainStationWorker_01`,
        coords = vector4(2759.21, -1416.27, 46.22, 125.34),
    },
    {   -- railroad job vanhorn station npc
        model = `U_M_O_RigTrainStationWorker_01`,
        coords = vector4(2891.21, 619.44, 57.72, 57.77),
    },
    {   -- railroad job annesberg station npc
        model = `U_M_O_RigTrainStationWorker_01`,
        coords = vector4(2951.42, 1282.26, 44.63, 161.22),
    },
    {   -- railroad job annesberg station npc
    model = `U_M_O_RigTrainStationWorker_01`,
    coords = vector4(589.15, 1679.48, 187.67, 344.76),
    },
    {   -- railroad job wallas station npc
    model = `U_M_O_RigTrainStationWorker_01`,
    coords = vector4(-1312.28, 393.41, 95.38, 323.69),
    },
    {   -- railroad job riggs station npc
    model = `U_M_O_RigTrainStationWorker_01`,
    coords = vector4(-1102.95, -574.11, 82.26, 129.27),
    },
    {   -- railroad job flatneck station npc
    model = `U_M_O_RigTrainStationWorker_01`,
    coords = vector4(-329.91, -348.86, 88.03, 17.07),
    },
    {   -- 木材回收商人
    model = `A_M_M_MiddleSDTownfolk_01`,
    coords = vector4(2417.8496, -1468.6090, 45.6086, 280.7021),
    },
