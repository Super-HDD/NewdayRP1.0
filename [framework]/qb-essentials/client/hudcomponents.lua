...
Citizen.CreateThread(function()
    while true do
        ...
        EnableControlAction(0,0x93D6723F,true)
        EnableControlAction(0,0x9E6A9358,true)
        EnableControlAction(0,0xD33B28BE,true)
        EnableControlAction(0,0xBA60039F,true)
        EnableControlAction(0,0x390948DC,true)
    end
end)
