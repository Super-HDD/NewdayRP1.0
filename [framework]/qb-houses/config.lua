...
-- settings
Config.BillingCycle     = 1 -- 将每 x 小时/秒删除积分
Config.LandTaxPerCycle  = 1 -- $ 每个周期增加的税额
Config.StartCredit      = 10
Config.CreditWarning    = 5 -- 5 x Config.LandTaxPerCycle 金额：警告将在 < 时触发：示例 5 x 1 = 5，因此电报将在 4 小时触发
Config.SellBack         = 0.8 -- 示例：0.5 = 购买价格的 50% / 0.8 = 购买价格的 80%
Config.StorageMaxWeight = 4000000
Config.StorageMaxSlots  = 50
Config.OwnedHouseBlips  = true -- 当设置为 true 时，只有拥有的房子才会显示光点
Config.PurgeStorage     = false -- 当房屋因不缴税而被收回时，清除房屋库存（默认禁用）

-- blip settings
Config.Blip =
{
    blipName            = '房地产商人', -- Config.Blip.blipName
