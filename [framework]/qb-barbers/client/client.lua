        ...
        exports['qb-target']:AddCircleZone(v.name, v.coords, 1, {
            ...
            debugPoly = false,
                ...
                options = {
                {
                    type = "client",
                    action = function()
                    TriggerEvent('qb-barber:client:menu', v.location)
                    end,
...
RegisterNetEvent("qb-barber:client:menu", function()
...
local MainMenus =
{
    ...
    ["save"] = function()
        ...
        TriggerServerEvent("qb-barber:server:SaveSkin", CreatorCache, male)
