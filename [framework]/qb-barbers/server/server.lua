...
RegisterServerEvent('qb-barber:server:SaveSkin')
AddEventHandler('qb-barber:server:SaveSkin', function(CreatorCache, gender)
    local src = source
    ...
    QBCore.Functions.Notify('You have purchased a new style!', 'success')
end)