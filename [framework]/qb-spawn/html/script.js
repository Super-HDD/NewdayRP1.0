...
function setupLocations(locations, myHouses) {
    ...
    $(parent).html("");
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="您想从哪里开始?"><p><span id="null">您想从哪里开始?</span></p></div>')
...
function setupnewLocations(apps) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="选择公寓"><p><span id="null">Choose a apartment</span></p></div>')
