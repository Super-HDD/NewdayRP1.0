...
function LightAndCam()
    while cam do
        ...
        DrawLightWithRange(-561.36, SpawnCoords[AcitveCamera].y, SpawnCoords[AcitveCamera].z + 1, 255, 255, 255, 5.5,
            25.0)
        local SelectString = Citizen.InvokeNative(0xFA925AC00EB830B9, 10, "LITERAL_STRING", QB.WelcomeText, Citizen.ResultAsLong())
        Citizen.InvokeNative(0xFA233F8FE190514C, SelectString)
        Citizen.InvokeNative(0xE9990552DEC71600)
        local ChoiceGroupName = CreateVarString(10, 'LITERAL_STRING', "选择一个角色")
...
function CreatorLight()
    Citizen.CreateThread(function()
        while CharacterCreatorCamera do
            ...
            local str = Citizen.InvokeNative(0xFA925AC00EB830B9, 10, "LITERAL_STRING", '按 ~INPUT_FRONTEND_LB~~INPUT_DYNAMIC_SCENARIO~ 旋转角色',
