...
function Form (_title, _subtitle, _elements, _submittable)
{
	...
	this.print = function () { 
		...
		html_footer += "</div>";
		html_footer += "<div id=\"signature_block\">尊敬的检察官，请在此处签署您的名字.</div>";

		/*  Cancel & Submit button */

		if (this.submittable) {
			html_footer += "<button id=\"button_cancel\" type=\"button\">取消签署</button>";
			html_footer += "<button id=\"button_submit\" type=\"button\">确认签署</button>";
		}
