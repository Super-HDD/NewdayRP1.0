...
CreateBlips = function()
	for town,data in pairs(Config.Projections) do
        ...
        Citizen.InvokeNative(0x9CB1A1623062F402, blip, CreateVarString(10, "LITERAL_STRING", "海妮耶斯电影院"))
    ...
    Citizen.InvokeNative(0x9CB1A1623062F402, blip, CreateVarString(10, "LITERAL_STRING", "面团歌剧厅"))
    SetBlipSprite(blip, `blip_ambient_theatre`)
